...
:: 1 representa "true" e 0 representa "false", o padrão é 0 
set allow_custom_colors=1

REM Adicionado cores personalizadas

:: Você definer uaa cor especifíca para cada questão/pergunta, e lembre-se, só
:: funcionar se a variável acima "allow_custom_colors" = 1 (boolean).
